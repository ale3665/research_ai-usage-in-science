...
class journalOfEngineering(Journal_ABC):
    def __init__(self) -> None:
        self.journalName: str = "PLOS"
        self.paperURLTemplate: Template = Template(
            template="https://onlinelibrary.wiley.com/doi/{paperID}"
        )  # noqa: E501
        self.searchURLTemplate: Template = Template(
            # add more months
            template="https://onlinelibrary.wiley.com/action/doSearch?field1=AllField&text1={query}&field2=AllField&text2=&field3=AllField&text3=&publication%5B%5D=3962&publication=&Ppub=&AfterMonth={month}&AfterYear={year}&BeforeMonth={month}&BeforeYear={year}"  # noqa: E501
        )
    ...
    def extractAbstractFromPaper(self, soup: BeautifulSoup) -> str:
        ...
        abstract: Tag = soup.find(
            name="section",
            attrs={"class": "article-section article-section__abstract"},
        )
    ...
    def extractDataSourcesFromPaper(self, soup: BeautifulSoup) -> str:
        ...
        tags: ResultSet = soup.find_all(
            name="section",
            attrs={
                "class": "article-section article-section__open-research",
            },
        )
