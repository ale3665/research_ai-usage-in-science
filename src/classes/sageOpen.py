...
class sageOpen(Journal_ABC):
    def __init__(self) -> None:
        self.journalName: str = "Sage Open"
        self.paperURLTemplate: Template = Template(
            template="https://journals.sagepub.com/doi/full/{paperID}"
        )  # noqa: E501
        self.searchURLTemplate: Template = Template(
            template="https://journals.sagepub.com/action/doSearch?field1=AllField&text1={query}&publication%5B%5D=sgoa&publication=&Ppub=&AfterMonth={month}&AfterYear={year}&BeforeMonth={month}&BeforeYear={year}&access=&pageSize=10&startPage={page}"  # noqa: E501
        )
    ...
    def extractTitleFromPaper(self, soup: BeautifulSoup) -> str:
        ...
        :rtype: str
        """  # noqa: E501
        title: Tag = soup.find(name="h1", attrs={"property": "name"})
