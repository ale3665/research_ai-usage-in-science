  ...
  - Must support at least Science and Nature
    - Currently working on Science
      - TOS of Science prevent automatic scraping. A message regarding this and
        explaining why no tool is provided will be made when the user selects
        the Science option. Links to the appropriate pages will be made
        availible at the bottom of the notice.
      - Done
    - Now working on Nature
