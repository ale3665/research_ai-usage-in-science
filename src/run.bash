...
aius-search-plot --input $PLOS_PATH/search_$DATE.parquet \
...
aius-filter-search-results --email $1 \
    --filter field \
...
aius-download-papers --input $PLOS_PATH/field_filteredSearch_$DATE.parquet \
    --output $PLOS_PATH/filtered_downloadedPapers_$DATE.parquet

# 5. Transform the downloaded papers into something usable
aius-transform-papers --input $PLOS_PATH/filtered_downloadedPapers_$DATE.parquet \
